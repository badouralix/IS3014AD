...
def main():
    ...
    cfg.add_edge(1, 2, typename="CIF", bexp=BBinOp('<=', AVariable('X'), AConstant(0)), com=CSkip())
    cfg.add_edge(1, 3, typename="CIF", bexp=BUnOp('!', BBinOp('<=', AVariable('X'), AConstant(0))), com=CSkip())
    ...
    cfg.add_edge(4, 5, typename="CIF", bexp=BBinOp('==', AVariable('X'), AConstant(1)), com=CSkip())
    cfg.add_edge(4, 6, typename="CIF", bexp=BUnOp('!', BBinOp('==', AVariable('X'), AConstant(1))), com=CSkip())
